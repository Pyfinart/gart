...
export default class ProjectSelector extends Component {
  render() {
    return (
    <div className="Frame48095496" style={{width: 1260 , height: '100%', alignItems: 'center', display: 'inline-flex'}}>
    ...
    {/* <div className="Frame48096668" style={{height: 40, justifyContent: 'flex-end', alignItems: 'flex-end',marginLeft:"auto", gap: 21, display: 'flex'}}>
        <div className="Search" style={{width: 320, height: 40, paddingLeft: 16, paddingRight: 16, paddingTop: 5, paddingBottom: 5, background: '#F0F2F5', borderRadius: 32, overflow: 'hidden', border: '1px black solid', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', gap: 10, display: 'inline-flex'}}>
                ...
                <div style={{width: 16, height: 16, left: 0, top: 3, position: 'relative', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'inline-flex'}}>
                ...
                <div className="SearchByNameOrTrait" style={{left: 24, top: 0, position: 'relative', color: 'black', fontSize: 14, fontFamily: 'Poppins', fontWeight: '400', wordWrap: 'break-word',width:200}}>Search by name or trait</div>
