...
const ProfileItem = (props) => {
    console.log("Profile Item Data",props.data);
  return (<ProfileItemPriced data={props.data}></ProfileItemPriced>);
};

const ProfileItemPriced = (props) => {
    return (
      ...
      <div className="Frame48095482" style={{width: 240, height: 300, justifyContent: 'flex-start', alignItems: 'flex-start', gap: 20, display: 'flex'}}>
          <div className="MarketplaceItemV1OnlightCopy" style={{flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10, display: 'inline-flex'}}>
              ...
              <div className="Frame48096662" style={{alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 20, display: 'inline-flex'}}>
                  <div className="Title" style={{width: "100%", height: 10, color: 'black', fontSize: 14, fontFamily: 'Inter', fontWeight: '600', wordWrap: 'break-word'}}>{props.data.name}</div>
              </div>
              <div className="Frame48096661" style={{flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 4, display: 'flex'}}>
                  <div className="Frame48096653" style={{justifyContent: 'center', alignItems: 'flex-start', gap: 12, display: 'inline-flex'}}>
                      ...
                      <div className="Floor" style={{justifyContent: 'flex-end', alignItems: 'center', display: 'flex'}}>
                          <div className="XtzIcon" style={{width: 22, height: 22, padding: 1, background: 'white', borderRadius: 11, overflow: 'hidden', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'flex'}}>    
                            <div className="XTZ-ICON">
                                <img className="icon-img" alt="Xtz ICON" src="Path.svg"/>
                            </div> 
                          </div>
                          <div className="Price" style={{width: 48, height:22, textAlign: 'right', color: 'black', fontSize: 14, fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word'}}>{props.data.price/1000000}</div>
                      </div>
                      <div className="Frame48096645" style={{width: 90, height: 21, paddingTop: 1, paddingBottom: 9, background: 'white', borderRadius: 100, border: '0.50px black solid', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10, display: 'flex'}}>
...
const ProfileItemUnpriced =(props) =>{
    return (
        <div className="MarketplaceItemV1OnlightCopy" style={{width: '100%', height: '100%', background: 'white', boxShadow: '0px 6px 6px rgba(0, 0, 0, 0.20)', borderRadius: 6, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', display: 'inline-flex'}}>
    <div className="MarketplaceItemV1OnlightCopy" style={{flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10, display: 'flex'}}>
        ...
        <div className="Frame48096661" style={{flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 4, display: 'flex'}}>
            <div className="Frame48096653" style={{justifyContent: 'center', alignItems: 'flex-start', gap: 12, display: 'inline-flex'}}>
                ...
                <div className="Frame48096645" style={{width: 90, height: 21, paddingTop: 9, paddingBottom: 9, background: 'white', borderRadius: 100, border: '0.50px black solid', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10, display: 'flex'}}>
